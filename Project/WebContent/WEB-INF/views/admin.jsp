...
.menu{
    ...
    cursor: pointer;
    border-radius: 10px;
    box-shadow: 1px 1px 4px rgb(167, 167, 167);
    ...
    <section>
        <div class="wrap">
            ...
            <div id="wrap2" class="wrap">
                <a href="/project/adminOrder" class="menu"><div>주문조회</div></a>
                <a href="/project/membercheck" class="menu"><div>회원조회</div></a>
                <a href="/project/goodsSearch" class="menu"><div>상품조회 및 관리</div></a>
            </div>
        </div>
    </section>
    <footer>
