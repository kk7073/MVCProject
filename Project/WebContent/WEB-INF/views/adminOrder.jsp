...
<body>
	...
	<section>
	<table id="table">
        <caption><h3>주문 조회</h3></caption>
		<tr class="t-col">
			<th onclick="sortTableNum(0)"><span class="left">주문번호</span><span class="right"><i class="fa-solid fa-sort"></i></i></span></th>
			<th onclick="sortTableStr(1)"><span class="left">상품이름</span><span class="right"><i class="fa-solid fa-sort"></i></i></span></th>
			<th onclick="sortTableNum(2)"><span class="left">수량</span><span class="right"><i class="fa-solid fa-sort"></i></span></th>
			<th onclick="sortTableStr(3)"><span class="left">고객번호</span><span class="right"><i class="fa-solid fa-sort"></i></span></th>
			<th onclick="sortTableStr(4)"><span class="left">고객명</span><span class="right"><i class="fa-solid fa-sort"></i></span></th>
			<th onclick="sortTableNum(5)"><span class="left">총가격</span><span class="right"><i class="fa-solid fa-sort"></i></span></th>
			<th onclick="sortTableStr(6)"><span class="left">구매날짜</span><span class="right"><i class="fa-solid fa-sort"></i></span></td>
		</tr>
<% 
